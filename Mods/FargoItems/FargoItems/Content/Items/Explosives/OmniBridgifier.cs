...
namespace FargoItems.Content.Items.Explosives
{
    public class OmniBridgifier : ModItem
    {
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            float ai0 = -1;
            if (player.inventory.Any(i => !i.IsAir && i.type == ModContent.ItemType("Fargowiltas", "Omnistation")))
                ai0 = 0;
            if (player.inventory.Any(i => !i.IsAir && i.type == ModContent.ItemType("Fargowiltas", "Omnistation2")))
        ...
        public override void AddRecipes()
        {
            ModRecipe.Create(Type)
                ...
                .AddTile(ModContent.TileType("Fargowiltas", "OmnistationSheet"))
                .Register();

            ModRecipe.Create(Type)
                .AddIngredient(ModContent.ItemType<InstaBridge>())
                .AddTile(ModContent.TileType("Fargowiltas", "OmnistationSheet2"))
                .Register();
        }
    }
}
