...
namespace FargoItems.Content.Systems
{
    ...
    public class InstaVisual : ModSystem
    {
        ...
        public static void DrawVisual(SpriteBatch spriteBatch)
        {
            ...
            if (drawPlayer != null && drawPlayer.Draw)
            {
                Texture2D texture = ModContent.Request<Texture2D>("FargoItems/Assets/InstaVisualSquare")?.Value;
    ...
    internal class InstaItemVisual : UIState
    {
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            for (int i = 0; i < steps; i += 1)
            {
                ...
                spriteBatch.Draw(TextureAssets.MagicPixel, new Rectangle(left + i, hitbox.Y, 1, hitbox.Height), Color.Lerp(gradientA, gradientB, percent));
            }
        }
