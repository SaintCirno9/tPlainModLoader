...
namespace Fargowiltas.Common.Systems.Recipes
{
    public class BannerRecipeSystem : ModSystem
    {
        ...
        public override void AddRecipeGroups()
        {
            ...
            AnyPirateBanner = RecipeLoader.RegisterGroup("Fargowiltas:AnyPirateBanner", group);
            ...
            AnyArmoredBonesBanner = RecipeLoader.RegisterGroup("Fargowiltas:AnyArmoredBonesBanner", group);
            ...
            AnySlimesBanner = RecipeLoader.RegisterGroup("Fargowiltas:AnySlimes", group);
            ...
            AnyHallowBanner = RecipeLoader.RegisterGroup("Fargowiltas:AnyHallows", group);
            ...
            AnyCorruptBanner = RecipeLoader.RegisterGroup("Fargowiltas:AnyCorrupts", group);
            ...
            AnyCrimsonBanner = RecipeLoader.RegisterGroup("Fargowiltas:AnyCrimsons", group);
            ...
            AnyJungleBanner = RecipeLoader.RegisterGroup("Fargowiltas:AnyJungles", group);
            ...
            AnySnowBanner = RecipeLoader.RegisterGroup("Fargowiltas:AnySnows", group);
            ...
            AnyDesertBanner = RecipeLoader.RegisterGroup("Fargowiltas:AnyDeserts", group);
            ...
            AnyBatBanner = RecipeLoader.RegisterGroup("Fargowiltas:AnyBats", group);
        }
            ...
            for (int i = 0; i < NPCID.Count; i++)
            {
                if (set[i])
                {
                    ...
                    if (bannerId > 0 && !bannersAdded.Contains(bannerId))
                    {
                        ...
                        RecipeHelper.CreateSimpleRecipe(0, resultID, TileID.Solidifier, disableDecraft: true);
                    }
                }
            }
        }
