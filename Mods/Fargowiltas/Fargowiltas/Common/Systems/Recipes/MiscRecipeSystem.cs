    ...
    public class MiscRecipeSystem : ModSystem
    {
        ...
        public override void PostAddRecipes()
        {
            ...
            foreach (Recipe recipe in Main.recipe)
            {
                ...
                {
                    var modItem = recipe.createItem.ModItem();
                    if (modItem != null && (modItem is BaseSummon || modItem is FleshyDoll || modItem is MechEye))
                    {
        ...
        private static void AddStatueRecipes()
        {
            ...
            var recipe = ModRecipe.Create(ItemID.KingStatue);
            ...
            recipe = ModRecipe.Create(ItemID.QueenStatue);
            recipe.AddIngredient(ItemID.Throne);
            recipe.AddIngredient(ItemID.TeleportationPotion);
            recipe.AddIngredient(ItemID.StoneBlock, 50);
            recipe.AddTile(TileID.HeavyWorkBench);
        ...
        {
            var recipe = ModRecipe.Create(statue);
        ...
        private static void AddMiscRecipes()
        {
            ...
            var recipe = ModRecipe.Create(ItemID.Terragrim);
            ...
            recipe = ModRecipe.Create(ItemID.GemSquirrelAmber);
            ...
            recipe = ModRecipe.Create(ItemID.GemSquirrelAmethyst);
            recipe.AddRecipeGroup(RecipeGroupID.Squirrels);
            ...
            recipe = ModRecipe.Create(ItemID.GemSquirrelDiamond);
            recipe.AddRecipeGroup(RecipeGroupID.Squirrels);
            ...
            recipe = ModRecipe.Create(ItemID.GemSquirrelEmerald);
            recipe.AddRecipeGroup(RecipeGroupID.Squirrels);
            ...
            recipe = ModRecipe.Create(ItemID.GemSquirrelRuby);
            recipe.AddRecipeGroup(RecipeGroupID.Squirrels);
            ...
            recipe = ModRecipe.Create(ItemID.GemSquirrelSapphire);
            recipe.AddRecipeGroup(RecipeGroupID.Squirrels);
            ...
            recipe = ModRecipe.Create(ItemID.GemSquirrelTopaz);
            recipe.AddRecipeGroup(RecipeGroupID.Squirrels);
            ...
            recipe = ModRecipe.Create(ItemID.FlowerBoots);
            ...
            recipe = ModRecipe.Create(ItemID.LivingLoom);
            ...
            recipe = ModRecipe.Create(ItemID.BabyBirdStaff);
            ...
            recipe = ModRecipe.Create(ItemID.LifeCrystal);
            ...
            recipe = ModRecipe.Create(ItemID.JungleRose);
            ...
            recipe = ModRecipe.Create(ItemID.NaturesGift);
            ...
            recipe = ModRecipe.Create(ItemID.AmberMosquito);
            ...
            recipe = ModRecipe.Create(ItemID.SandstorminaBottle);
            ...
            recipe = ModRecipe.Create(ItemID.ShroomiteBar);
            ...
            recipe = ModRecipe.Create(ItemID.WebSlinger);
            ...
            recipe = ModRecipe.Create(ItemID.FlyingCarpet);
            recipe.AddIngredient(ItemID.PharaohsMask);
            recipe.AddIngredient(ItemID.PharaohsRobe);
            recipe.AddIngredient(ItemID.GoldCoin, 10);
            recipe.AddTile(TileID.TinkerersWorkbench);
            ...
            recipe = ModRecipe.Create(ItemID.FartInABalloon);
            ...
            recipe = ModRecipe.Create(ItemID.BalloonHorseshoeFart);
            ...
            recipe = ModRecipe.Create(ItemID.TeleportationPylonVictory);
            ...
            recipe = ModRecipe.Create(ItemID.KiteBlueAndYellow);
            ...
            recipe = ModRecipe.Create(ItemID.KiteRedAndYellow);
            ...
            recipe = ModRecipe.Create(ItemID.MusicBox);
            ...
            recipe = ModRecipe.Create(ItemID.WetBomb);
            ...
            {
                recipe = ModRecipe.Create(familiars[i]);
