...
namespace Fargowiltas.Items.Tiles
{
    public class CrucibleCosmosSheet : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            // TileID.Sets.CountsAsHoneySource;
            // TileID.Sets.CountsAsLavaSource;
            // TileID.Sets.CountsAsWaterSource;

            //if (null != null)
            //{
            //    Array.Resize(ref AdjTiles, AdjTiles.Length + 3);
            //    AdjTiles[AdjTiles.Length - 1] = 0;
            //    AdjTiles[AdjTiles.Length - 2] = 0;
            //    AdjTiles[AdjTiles.Length - 3] = 0;
            //}
