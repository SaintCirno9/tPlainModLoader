...
namespace Fargowiltas.NPCs
{
    ...
    public class Mutant : ModNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            Happiness.SetBiomeAffection<HallowBiome>(AffectionLevel.Dislike);

            Happiness.SetNPCAffection<Abominationn>(AffectionLevel.Love);
            Happiness.SetNPCAffection<Deviantt>(AffectionLevel.Like);
            Happiness.SetNPCAffection<LumberJack>(AffectionLevel.Dislike);
        ...
        public override void SetDefaults()
        {
            ...
            /*
            if (Fargowiltas.ModLoaded["FargowiltasSouls"] && (bool)0)
            {
                NPC.lifeMax = 77000;
                NPC.defense = 360;
            }
        ...
        public override void AddShops()
        {
            var npcShop1 = new NPCShop(Type, ShopName1)
                .Add(new Item(ItemType<Overloader>(), 1) { shopCustomPrice = Item.buyPrice(copper: 400000) }, Condition.InExpertMode)
                .Add(new Item(ItemType<ModeToggle>(), 1));

            if (Fargowiltas.ModLoaded["FargowiltasSouls"] && TryFind("FargowiltasSouls", "Masochist", out ModItem masochist))
            {
                npcShop1.Add(new Item(masochist.Type, 1) { shopCustomPrice = Item.buyPrice(copper: 10000) }); //mutants gift
            }
            ...
            foreach (MutantSummonInfo summon in Fargowiltas.summonTracker.SortedSummons)
            {
                ...
                {
                    npcShop1.Add(new Item(summon.itemId, 1) { shopCustomPrice = Item.buyPrice(copper: summon.price) }, new Condition("Mods.Fargowiltas.Conditions.DownedTheBoss", summon.downed));
                }
            }
            ...
            foreach (MutantSummonInfo summon in Fargowiltas.summonTracker.SortedSummons)
            {
                ...
                {
                    npcShop2.Add(new Item(summon.itemId, 1) { shopCustomPrice = Item.buyPrice(copper: summon.price) }, new Condition("Mods.Fargowiltas.Conditions.DownedTheBoss", summon.downed));
                }
            }
            ...
            foreach (MutantSummonInfo summon in Fargowiltas.summonTracker.SortedSummons)
            {
                ...
                {
                    npcShop3.Add(new Item(summon.itemId, 1) { shopCustomPrice = Item.buyPrice(copper: summon.price) }, new Condition("Mods.Fargowiltas.Conditions.DownedTheBoss", summon.downed));
                }
            }

            npcShop3.Add(new Item(ItemType<AncientSeal>(), 1) { shopCustomPrice = Item.buyPrice(copper: 100000000) });

            npcShop1.Add(new Item(ItemType<SiblingPylon>(), 1), Condition.HappyEnoughToSellPylons, Condition.NpcIsPresent(NPCType<Abominationn>()), Condition.NpcIsPresent(NPCType<Deviantt>()));
            npcShop2.Add(new Item(ItemType<SiblingPylon>(), 1), Condition.HappyEnoughToSellPylons, Condition.NpcIsPresent(NPCType<Abominationn>()), Condition.NpcIsPresent(NPCType<Deviantt>()));
            npcShop3.Add(new Item(ItemType<SiblingPylon>(), 1), Condition.HappyEnoughToSellPylons, Condition.NpcIsPresent(NPCType<Abominationn>()), Condition.NpcIsPresent(NPCType<Deviantt>()));
        ...
        {
            // FargowiltasSouls discount card logic commented out for Track B
        }
        ...
        {
            /*
            if (Fargowiltas.ModLoaded["FargowiltasSouls"] && (bool)false && TryFind("FargowiltasSouls", "MutantSpearThrownFriendly", out ModProjectile penetrator))
            {
