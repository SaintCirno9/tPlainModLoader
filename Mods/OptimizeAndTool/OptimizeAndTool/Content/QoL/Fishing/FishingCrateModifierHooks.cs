...
{
    /// <summary>
    /// 钓鱼宝匣掉落几率修改与倍率计算门控（基于 HookGen 强类型 On_ 门控）
    /// 作者: SaintCirno9
    /// </summary>
    internal class FishingCrateModifierHooks
    {
        ...
        public static void RegisterAll()
        {
            ...
            On_Projectile.FishingCheck_RollDropLevels += Hook_FishingCheck_RollDropLevels;
            _registered = true;
        }
        ...
        /// </summary>
        private static void Hook_FishingCheck_RollDropLevels(
            On_Projectile.orig_FishingCheck_RollDropLevels orig,
            Projectile self,
            int fishingLevel,
            out bool common,
            out bool uncommon,
    ...
    /// 兼容别名类
    /// </summary>
    internal class FishingCrateModifier : FishingCrateModifierHooks
    {
    }
}