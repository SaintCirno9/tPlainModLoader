...
{
    /// <summary>
    /// 钓鱼环境与任务鱼信息 HUD 门控（基于 HookGen 强类型 On_ 门控）
    /// 在玩家手持钓竿时于屏幕左侧实时显示水体大小、液体类别、打窝数、今日任务鱼、宝匣设置与挂机战利品收益统计
    /// 作者: SaintCirno9
    /// </summary>
    internal class FishingInfoHUDHooks
    {
        ...
        public static void RegisterAll()
        {
            ...
            On_Main.DrawInterface_36_Cursor += Hook_DrawInterface_36_Cursor;
            _registered = true;
        }
        ...
        private static void Hook_DrawInterface_36_Cursor(On_Main.orig_DrawInterface_36_Cursor orig)
        {
            orig();
    ...
    /// 兼容别名类
    /// </summary>
    internal class FishingInfoHUD : FishingInfoHUDHooks
    {
    }
}