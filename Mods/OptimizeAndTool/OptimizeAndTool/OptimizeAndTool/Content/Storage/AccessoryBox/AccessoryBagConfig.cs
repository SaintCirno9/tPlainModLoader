...
namespace OptimizeAndTool.Content.Storage.AccessoryBox
{
    ...
    public static class AccessoryBagConfig
    {
        ...
        public static List<UIElement> GetUI()
        {
            ...
            {
                UIBuild.get2(EnablePassive, "饰品袋被动属性生效：袋内饰品属性与词缀无需装备直接生效", "Images/Item_158", "饰品袋属性生效"),
                UIBuild.get2(PreventBagDuplicates, "包内防重复：禁止在同一个饰品袋中放入同种饰品", "Images/UI/InfoIcon_0", "包内防重复"),
                UIBuild.get2(PreventPlayerBagDuplicates, "角色互斥防重：禁止放入角色身上已装备的同种饰品", "Images/UI/InfoIcon_1", "角色互斥防重"),
                UIBuild.get1(EnableEffectiveSlotsLimit, EffectiveSlots, int.Parse, "限制饰品袋前 N 个槽位的饰品属性生效（其余槽位仅作收纳）", "Images/UI/InfoIcon_5", "生效槽位限制"),
