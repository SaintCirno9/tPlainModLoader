...
namespace PipetteTool.Core
{
    ...
    public static class PipetteEngine
    {
        ...
        public static void PerformPipette()
        {
            ...
            if (!PipetteConfig.Enable) return;
            ...
            if (tileX >= 0 && tileX < Main.maxTilesX && tileY >= 0 && tileY < Main.maxTilesY)
            {
                ...
                if (tile != null)
                {
                    targetItemId = TileToItemResolver.ResolveTileOrWallToItemId(tile, player, PipetteConfig.PickWall);
                }
            }
            ...
            if (targetItemId <= 0)
            {
                ...
                else if (PipetteConfig.ShowNotification)
                {
            ...
            for (int i = 0; i < 50; i++)
            {
                ...
                if (invItem != null && invItem.type == targetItemId && invItem.stack > 0)
                {
                    ...
                    if (PipetteConfig.ShowNotification)
                    {
