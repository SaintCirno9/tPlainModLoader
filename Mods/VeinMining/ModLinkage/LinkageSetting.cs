...
namespace VeinMining.ModLinkage
{
    ...
    internal class LinkageSetting : ModSetting
    {
        ...
        public override string Title => "简单连锁挖矿: 模组联动设置";
        ...
        public override void Load(object v)
        {
            ...
            {
                (a => ModQuickSetting.IsLinkage = a, "Images/Item_3507", "添加到快捷设置 (QuickSetting)"),
                (a => ModQuickButton.IsLinkage = a, "Images/Item_3507", "添加到悬浮工具栏 (QuickButton)")
            };
